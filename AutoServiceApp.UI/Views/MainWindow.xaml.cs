...
namespace AutoServiceApp
{
    public partial class MainWindow : Window
    {
        ...
        {
            var statusItems = new List<string> { "Все статусы", "Новая", "В процессе", "Завершена" };
        ...
        private void LoadRequests()
        {
            try
            {
                ...
                var filter = new RepairRequestsFilter { SearchText = string.IsNullOrWhiteSpace(searchText) ? null : searchText, Status = status };
                var requests = _repository.GetAll(filter);
        ...
        {
            var allRequests = _repository.GetAll(RepairRequestsFilter.Empty);
        ...
        {
            var statisticsService = new AutoServiceApp.Services.StatisticsService(_repository);
